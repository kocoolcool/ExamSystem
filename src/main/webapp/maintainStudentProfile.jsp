...
<!-- 								Hamburger -->
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<div align="center">
			...
			<!--  註冊的表單 -->
			<form:form method="POST" modelAttribute="studentBean" enctype= "multipart/form-data" action="maintainStudentProfile?startWorkDate=${studentBean.startWorkDate}"><!-- action="updateExam"-->
<%-- 			action="?startWorkDate=${studentBean.startWorkDate}" --%>
...
<!-- 					<legend style="text-align: center">新增考試資料</legend> -->
					...
					<div style="width: 300px; height: 595px; border: 3px; text-align: left">
					
						<div>      
<!-- 							<label for='studentId'>學生的ID</label> -->
							<div>
								<form:input id="studentId" path="studentId" type='hidden' />
							</div>
						</div>
						
						
						<div>      
<!-- 							<label for='thisIsClass'>班級</label> -->
							<div>
								<form:input id="thisIsClass" path="thisIsClass" type="hidden" />
							</div>
						</div>
						...
						<div>
							...
							<div>
								<form:radiobutton path="gender" value="男" />
								男
...
<!-- 							<label for='Score'> 考試分數 </label> -->
							<div>
								<form:input id="Score" path="Score" type="hidden" />
							</div>
						</div>
						...
						<div>
<!-- 							<label for='salary'> 工作期望之薪資 </label> -->
							<div>
								<form:input id="salary" path="salary" type="hidden" />
							</div>
						</div>
						...
						<div>
<!-- 							<label for='whichIdentity'> 身分識別碼 </label> -->
							<div>
								<form:input id="whichIdentity" path="whichIdentity" type="hidden" />
							</div>
						</div>


						<div>
<!-- 							<label for='encryptURL '> 個人加密的網址 </label> -->
							<div>
								<form:input id="encryptURL " path="encryptURL" type="hidden" />
							</div>
						</div>
...
<!-- 							<label for='classID'> classID </label> -->
							<div>
								<form:input id="classId" path="classId" type="hidden" />
							</div>
						</div>						
						...
						<div> 
 						...
 						<div> 
<!--  							<label for="photoName"> 照片的名稱 </label> -->
  							<div>
  								<form:input type="hidden" id="photoName" path="photoName" />
  							</div>
  						</div>
