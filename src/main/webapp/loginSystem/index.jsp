...
<!--為了左上角2方塊   結束//-->
    ...
    <div style="height:35px; width:350px; position:absolute; top:8%; left:75%; margin:0px 0 0 -320px; border:3px">
	  <span><a href="index" style="color:grey; text-align: center"><b>首頁</b></a>　　　　　<a href="loginSystem/logouttt" style="color:grey; text-align: center">測試鈕</a>　　　　　<a href="ContactUs" style="color:grey; text-align: center">聯絡我們</a></span>
    </div>
	<!-- <hr> -->
	<!-- 背景圖 -->
	...
	<table border="1" style="margin: 0px auto;">
			...
			<div align="center" style="width:320px; position:absolute; top:22%; left:88%; margin:-150px 0 0 -280px; border:3px">
			  <p>登入或註冊</p>
			  <BR>
			  <div><a href="/ExamSystem/index_forLogin1">
