...
<!-- 選單 選單 選單 選單 選單(qwe)-->					
        ...
        <ul class="nav-menu" >
            <li class="nav-item">
                <a  href="index_Student">Home</a>
            </li>
            <li class="nav-item">
                <a  href="examAppointment/AppAllExam">Appointment</a>
                <div class="sub-nav">
                    <ul class="sub-nav-group">
                        <li><a href="examAppointment/AppAllExam">Exam Appointment</a></li>
                    </ul>
			...
			<div class="container">
				<div class="row">
					<div class="col">
					  ...
					  <!--zxc--><li style="color:Black">歡迎您登入考試系統之學生首頁</li><!--<font size="3"></font>-->
								<!-- 這邊記得修改當前所在位置 -->
							</ul>
						</div>
					</div>
