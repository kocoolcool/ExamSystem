...
//   session.removeAttribute("WhichIdentity");
// }
%>
...
<!------------------------這邊填上登入頁面Google Login(asd)------------- -->
								<div class="top_bar_login ml-auto">
								    ...
								    <div style="float:left"><p>　　</p></div>								    
									<div style="float:left"><p style="color:Black"><font size="3"></font></p></div>
...
<!-- 							</div> -->
		...
		<div align="center" >
		  ...
		  <div style="border:2px blue solid; width:500px; height:395px; font-size:35px; text-align: center">
		  			  <BR>
			          <BR>
<!-- 			          <BR> -->
			<H1 style="text-align: center">
				你已登出本系統！
					  ...
					  <BR>
 					  ...
 					  <!-- 自動跳轉頁(bpart)--> 
					  <div style="text-align: center; color:grey; font-size:22px">
<!-- <div style="font-size:35px"> -->
<!-- 你已登出本系統！<BR> -->
<span id="time" >25</span> 秒鐘之後將自動跳轉，如果不跳轉，<BR>
請點擊這裡 <a href="../index">到首頁</a> 
<script type="text/javascript"> 
delayURL("http://localhost:8080/ExamSystem/"); 
</script> 
