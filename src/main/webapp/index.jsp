...
#learn-more {
  ...
  -webkit-transition: all 25000000ms ease-in;
  transition: all 25000000ms ease-in;
  cursor: pointer;
}
#learn-more:hover {
  fill-opacity: 1;
...
.service.active .icon-wrapper, .service.active .icon-wrapper > *, .service:hover .icon-wrapper, .service:hover .icon-wrapper > * {
  -webkit-transition: all 25000000ms ease-out;
  transition: all 25000000ms ease-out;
}
...
<body>
  <!--  為了左上角的2方塊-->
   <div class="container" style="height:500px; width:590px; position:absolute; top:19%; left:21%; margin:0px 0 0 -320px; border:3px">
     <div><img style="height:107px; width:235px" src="images/forIndexAA.jpg" title="Java" alt="JavaExam">
     </div>
     <div>　<img style="height:107px; width:235px" src="images/forIndexBBB.jpg" title="Java" alt="JavaExam">
     </div>
     <div><img style="height:107px; width:235px" src="images/forIndexAA.jpg" title="Java" alt="JavaExam"></div>
   </div>
<!--container end.//-->
<!--為了左上角2方塊   結束//-->
    ...
    <div style="height:35px; width:350px; position:absolute; top:8%; left:75%; margin:0px 0 0 -320px; border:3px">
	  <span><a href="index" style="color:grey; text-align: center"><b>首頁</b></a>　　　　　<a href="loginSystem/forSuccessRegister" style="color:grey; text-align: center">測試鈕</a>　　　　　<a href="ContactUs" style="color:grey; text-align: center">聯絡我們</a></span>
    </div>
	<!-- <hr> -->
	<!-- 背景圖 -->
	...
	<table border="1" style="margin: 0px auto;">
                                                               <!--    top:35%; -->
			<div align="center" style="width:320px; position:absolute; top:22%; left:88%; margin:-150px 0 0 -280px; border:3px">
			  <p>登入或註冊</p>
			  <BR>
			  <div><a href="loginSystem/index_forLogin1">
			    <button type="button" class="btn btn-primary">這裡</button></a></div>
			</div>
...
<!-- 右下角的選單   開始-->
<div style="border:3px; height:380px; width:800px; position:absolute; top:15%; left:72%; margin:0px 0 0 -300px;">


<div class="container">
                                  <!-- 選單 的相對大小-->
  <svg id="circle-nav-services" width="120%" height="120%" viewBox="0 0 650 550">
    <defs>
    ...
    <symbol id="circle-nav-copy" viewBox="0 0 300 300">
      ...
      <text class="cls-1" transform="translate(99 1865)">
        <tspan class="cls-2" x="18" y="0">其他</tspan>
...
<!--         <tspan x="159" y="0">ocess, </tspan> -->
        <tspan x="10" y="15">，請點選地圖與聯繫，您可以 </tspan>
        <tspan x="-5" y="41">從地圖上直接找到我們的位置。</tspan>
...
<!--         <tspan x="-23" y="19">complete their p</tspan> -->
        <tspan class="cls-6" x="12" y="22">點選寄信鈕即可發信給我們。</tspan>
...
<!--         <tspan x="121" y="58">ements.</tspan> -->
      ...
      <text class="cls-1" transform="translate(75 666)">有關於考試</text>
      <text class="cls-5" transform="translate(83 710)">
        <tspan class="cls-7" x="0" y="0"></tspan>
        <tspan x="12" y="0">您可以在未登入前查詢</tspan>
        <tspan x="-27" y="25">考試相關訊息，登入後進行</tspan>
<!--         <tspan class="cls-6" x="-18" y="19">r</tspan> -->
<!--         <tspan x="-13" y="19">oductivity enhancement.</tspan> -->
        <tspan x="-27" y="50">自己想要的報名！</tspan>
...
<!--         <tspan x="-19" y="96">Managment P</tspan> -->
...
<!--         <tspan x="118" y="96">ams.</tspan> -->
      ...
      <text class="cls-1" transform="translate(82 65)">關於本網站</text>
      <text class="cls-5" transform="translate(63 108)">本網站導覽選單將幫助您
        <tspan x="-9" y="27">了解註冊前您可使用的網站</tspan><!--  <tspan x="-9" y="19">了解註冊前您可使用的網站</tspan> -->  
<!--         <tspan class="cls-6" x="71" y="19">t</tspan> -->
<!--         <tspan x="76" y="19">o work within a </tspan> -->
<!--         <tspan class="cls-8" x="-1" y="38">r</tspan> -->
        <tspan x="0" y="52">功能，及本站使用之登入 </tspan><!--    <tspan x="0" y="38">功能，及本站使用之登入 </tspan> -->
        <tspan x="-18" y="77">系統，請點選下方之環狀選單</tspan><!--  <tspan x="-18" y="58">系統，請點選下方之環狀選單</tspan> -->
...
<!--         <tspan class="cls-6" x="3" y="77">t</tspan> -->
        <tspan x="8" y="105">瞭解你想使用的功能！ </tspan> <!--         <tspan x="8" y="77">瞭解你想使用的功能！ </tspan> -->
...
<!--         <tspan x="24" y="96">olving expectations.</tspan> -->
      ...
      <text class="cls-5" transform="translate(46 437)">
        <tspan class="cls-19" x="8" y="-30">本站採綁定Google帳號登入及</tspan>
        <tspan x="8" y="-5">註冊機制，在您以Google Email</tspan>
<!--         <tspan class="cls-19" x="173" y="0">r</tspan> -->
<!--         <tspan x="178" y="0">tise, </tspan> -->
        <tspan x="1" y="19">帳號進行註冊後，便會由系統將您</tspan>
<!--         <tspan class="cls-6" x="34" y="19">r</tspan> -->
        <tspan class="cls-11" x="5" y="43">自動導向考生(/學生)首頁，您可以</tspan>
<!--         <tspan x="48" y="19">vide Commissioning & </tspan> -->
<!--         <tspan x="6" y="38">Qualification and Computer </tspan> -->
        <tspan class="cls-17" x="1" y="66">在該頁面進行考試預約及更新</tspan>
        <tspan x="15" y="90">考生個人資料、以及和主考官</tspan>
        <tspan x="12" y="112">使用Google Hangout系統</tspan>
        <tspan x="37" y="135">即時聯絡進行對談。</tspan>
      </text>
      <text class="cls-1" transform="translate(138 1266)">
        <tspan x="-80" y="28">後臺系統</tspan>
      </text>
      <text class="cls-5" transform="translate(47 1323)">
<!--         <tspan class="cls-6" x="146" y="0">x</tspan> -->
        <tspan x="50" y="0">系統之後台登入亦採</tspan>
        <tspan x="11" y="27">Google帳號登入，主考官及系 </tspan>
        <tspan x="8" y="50">統管理者亦能使用Google Email</tspan>
<!--         <tspan class="cls-7" x="-5" y="58">r</tspan> -->
        <tspan x="8" y="77">帳號針對考試的流程進行管理。</tspan>
<!--         <tspan x="-1" y="90"> </tspan> -->
<!--         <tspan x="40" y="96">l</tspan> -->
<!--         <tspan class="cls-15" x="44" y="96"></tspan> -->
<!--         <tspan x="60" y="120"></tspan> -->
      </text>
    </symbol>
...
var services_data = [{ name: "系統導覽圖", icon: "industries" }, { name: "登入之機制", icon: "validation" }, { name: "考試", icon: "engineering" }, { name: "寄信", icon: "management" }, { name: "後台", icon: "manufacturing" }, { name: "地圖與聯繫", icon: "technical" }, { name: "其他", icon: "process" }];
